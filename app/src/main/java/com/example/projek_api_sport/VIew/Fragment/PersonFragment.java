...
public class PersonFragment extends Fragment {
    ...
    private Observer<ArrayList<PersonDiscoverResultSportsItem>> getPersonDiscover   =    new Observer<ArrayList<PersonDiscoverResultSportsItem>>() {
        @Override
        public void onChanged(ArrayList<PersonDiscoverResultSportsItem> personDiscoverResultSportsItems) {
            if(personDiscoverResultSportsItems != null)
            {
                personDiscoverAdapter.setData(personDiscoverResultSportsItems);
            }
        }
    };
}
